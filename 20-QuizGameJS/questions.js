export let quizOneQ = [
   {
      numb: 1,
      question: "Who has the longest shlong",
      answer: "Madona",
      options: ["Madona", "Al Gore", "Pandora", "Eve"],
   },
   {
      numb: 2,
      question: "Animal has the longest shlong",
      answer: "Bird",
      options: ["Elephant", "Gorilla", "Panda", "Bird"],
   },
];
...
//          options: ["Boxing Day", "Cricket Day", "Wrestling Day", "Hockey Day"],
